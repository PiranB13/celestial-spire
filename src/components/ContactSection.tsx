        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12">
          <RevealItem direction="left" className="lg:col-span-3">
            ...
            >
              ...
              <button type="submit" disabled={submitted} className="w-full py-4 rounded-lg bg-primary text-primary-foreground font-semibold flex items-center justify-center gap-2 hover:bg-primary/90 active:scale-[0.99] transition-all duration-200 disabled:opacity-70">
